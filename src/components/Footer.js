"use client";
import { Container, Row, Col, a } from "react-bootstrap";
export default function Footer(props) {
  return (
    <footer>
      <Container fluid className={props.pressstart2p}>
        <Row>
          <Col
            xs={12}
        ...
        <Row>
          <Col md={4} className="socials">
            <a href="https://github.com/Mariuscv9" className="github">
          ...
          <Col md={4} className="socials">
            <a href="mailto:enachemarius2012@gmail.com" className="mail">
          ...
          <Col md={4} className="socials">
            <a
              href="https://www.linkedin.com/in/marius-enache-a14080252/"
              className="linkedin"
            >
              <svg viewBox="0 0 128 128">
                <path
      ...
      <Container fluid className="base">
        Built with Next.Js © Copyright 2023, Marius Enache All Rights Reserved.{" "}
      </Container>
    </footer>
  );
}
